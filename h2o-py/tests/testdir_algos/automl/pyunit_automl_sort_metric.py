...
def automl_leaderboard_sort_metric():
    ...
    aml = H2OAutoML(max_models=10, project_name="py_lb_test_aml1", exclude_algos=exclude_algos, seed=automl_seed, sort_metric="logloss")
    ...
    aml = H2OAutoML(max_models=10, project_name="py_lb_test_aml3", exclude_algos=exclude_algos, seed=automl_seed, sort_metric="logloss")
